...
<head>
    ...
    <title>Trending Courses Australia</title>
...
$image_query = mysqli_query($result,"select CourseName,img,description,Universities from TrendingCoursesAustralia ");
...

{
    ...
    <div class="container main">
        <div class="img-box">
            ...
            <br>
            <br>
            <p style="margin-left:390px;margin-top: 50%; align-content: center"><strong><?php echo $universitiesAvailable; ?></strong></p>
