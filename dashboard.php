        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" >
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                if (isset($_SESSION['username'])){
                    ...
                    <a class=\"nav-link js-scroll-trigger\" href=\"dashboard.php\" style=\"color:#ff4500 \">My Dashboard</a>
                </li>";
                    echo "<li class=\"nav-item\">
...
$shortlistedQuery = mysqli_query($result,"SELECT distinct name,img,url,world_ranking,description,id FROM universities,shortlisteduni where shortlisteduni.studentName = '$username' AND universities.id = shortlisteduni.UNiversityID");
...

{
    ...
    <div class="container main">
        <div class="img-box">
            <div class="img-block">
                <form action="deleteShortlist.php" method="post" id="form1">
            ...
            <button class="button" name="id" type="submit" form="form1" onclick="this.form.submit();this.innerText='Removed';this.style.backgroundColor='#999';" value="<?php echo $uniID; ?>"  style="font-size: large; margin-left: 25%;background-color:#ff4500;color: white; border-radius: 15px; padding: 10px"><strong>Remove</strong></button>
            </form>
        </div>
    </div>
